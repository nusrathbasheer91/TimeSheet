...
Public Class TEmp
    ...
    Private Sub ButtonTransfer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonTransfer.Click
        ...
        If (Textoutacc.Text = "" Or Textoutcode.Text = "" Or TextOutDate.Text = "") Then
            errornum = 1
    ...
    Public Sub CheckID()
        ...
        Dim sqlQ1 As String = "SELECT * from employee where id= all(select id from employee where badge_no='" & badge & "') and code='" & Textoutcode.Text & "';"
        Dim sqlAdapter1 As New MySqlDataAdapter
        Dim SQLCmd1 As New MySqlCommand
        Dim table As New DataTable
